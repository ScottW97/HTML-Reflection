...
function openSlideMenu() {
  ...
  document.getElementById("menuclick").innerHTML =
    '<button id="menubutton"><i class="fas fa-times nmsideclick"></i><br>MENU</button>';
...
function closeSlideMenu() {
  ...
  document
    .getElementById("menuclick")
    .setAttribute("onClick", "openSlideMenu()");
  document.getElementById("menuclick").innerHTML =
    '<button id="menubutton"><i class="fas fa-bars nmsideclick"></i><br>MENU</button>';
  document.getElementById("bodyscroll").style.overflow = "visible";
  setTimeout(function openSlideMenu() {
    document.getElementById("bgcolor").setAttribute("onClick", "");
  }, 100);
  setTimeout(function openSlideMenu() {
